const Blogs = [
  {
    ...
    img: require("../img/blog/topic1.png"),
    subTitle:
  ...
  },
  {
    ...
    img:require("../img/blog/topic2.png"),
    subTitle:
      "Social networks are the best link to close the gap between scientists and society",
  },
  {
    title: "Thinking outside the box",
    img:require("../img/blog/topic3.png"),
    subTitle:
      "Moving from the comfort zone to the unknown",
  },
  {
    title: "Learn how to create a killing Graphical Abstract in only five steps ",
    img:require("../img/blog/topic4.png"),
    subTitle:
